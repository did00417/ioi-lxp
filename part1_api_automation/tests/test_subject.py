...
def test_fetch_sbj_list(classroom_client, valid_headers, params):
...
def test_fetch_sbj_list_invalid_classid(classroom_client, valid_headers, params):
    """STU-SBJ-01-002: 올바르지 않은 클래스 id로 학습 목록 조회"""
    invalid_classroom_id = params['invalid_classroom_id']
    count = 10
...
def test_fetch_sbj_list_no_parameter(classroom_client, valid_headers, params):
...
def test_fetch_sbj_detail(classroom_client, valid_headers, params):
...
def test_fetch_sbj_map(base_client, valid_headers, params):
