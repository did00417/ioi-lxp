...
@pytest.fixture(scope="session")
def test_subject_data(file_manager):
    data = file_manager.read_json("test_subject_data.json")

    data["params"]["student_id"] = data["params"]["student_id"].format(STUDENT_ID=os.getenv("STUDENT_ID"))
